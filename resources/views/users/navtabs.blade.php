<ul class="nav nav-tabs nav-justified mb-3">
    ...
    <li class="nav-item"><a href="{{ route('users.unfavorites', ['id' => $user->id]) }}" class="nav-link {{ Request::is('users/*/unfavorites') ? 'active' : '' }}">Unfavorites <span class="badge badge-secondary">{{ $count_unfavorites }}</span></a></li>
</ul>
</ul>